...
public class DirectoryReaderServiceImp implements DirectoryReaderService {
	...
	@Autowired
	private ReciboSinIdentificarRepository recibosRepository;
	...
	public Set<String> machear() throws Exception {
		...
		Iterable<ReciboSinIdentificar> recibos = recibosRepository.findAll();
